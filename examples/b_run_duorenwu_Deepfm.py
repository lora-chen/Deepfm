...
'''
改好了测试集比例
要做三个输出，recall，准确，和F1
这个有保存文档，history做出来保存文件
'''

 # 'output1_recall': [0.0], 'output1_precision': [0.0], 'output2_acc': [0.2843248], 'output2_recall': [0.0], 'output2_precision': [0.0], 'val_loss': [3.994481296247805], 'val_output1_loss': [1.9651623], 'val_output2_loss': [2.0305283], 'val_output1_acc': [0.05540118], 'val_output1_recall': [0.0], 'val_output1_precision': [0.0], 'val_output2_acc': [0.30965614], 'val_output2_recall': [0.0], 'val_output2_precision': [0.0]}
...
if __name__ == "__main__":
    ...
    model.compile(optimizer='adam',
                  ...
                  loss_weights={'output1': 1, 'output2': 1}, metrics=['acc',Recall(),Precision()])
